...
// Helper function to initialize tenant schema if needed
async function initializeTenantSchema(db: Database, tenantId: string) {
  // Currently we use a shared schema with tenant_id columns.
  // This function is kept for future tenant-specific isolation logic.
  return;
}
  ...
  try {
    ...
    await db.exec(`
      CREATE TABLE IF NOT EXISTS products (
        ...
        image_url TEXT, -- Added for backward compatibility/simplicity
